const bridge = {
    ...
    labels: [
        ...
        },
        {
            ...
            description: `Костел и монастырь ордена босых кармелитов XVIII в. был разобран в 1903 г. при реконструкции комплекса под казармы гродненского крепостного батальона. Ныне здание банка.`,
            infoPosition: 1880,
            galleryStyle: {
